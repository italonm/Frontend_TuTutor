        ...
        <v-container>
          <v-form ref="form" v-model="valid" :lazy-validation="lazy">
              ...
              <div class="form-group">
                    ...
                    <select v-model= "signtipo.tt_periodicity" class="form-control" id="exampleFormControlSelect1" >
                ...
                <label class="c-switch c-switch-label c-switch-pill c-switch-opposite-success">
                    <input type="checkbox" class="c-switch-input" checked color='success' @click='cambiarvalorOblig'>
                ...
                <label class="c-switch c-switch-label c-switch-pill c-switch-opposite-success">
                    <input type="checkbox" class="c-switch-input" checked @click='cambiarvalorAsignar'>
                    <span class="c-switch-slider" data-checked="Si" data-unchecked="No"></span>
                </label>
                </el-row>
                </el-container>
