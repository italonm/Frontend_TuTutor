      ...
      <v-card-text>
        <v-container>
          <v-form ref="form" v-model="valid" :lazy-validation="lazy">
            <h4>Datos del tipo de tutoría</h4>
            <v-col cols="12" md="12">
              <v-text-field
            ...
            <h4>Detalles del tipo de tutoría</h4>

            <v-card class="pa-2" outlined style="border-color: lightgrey;" tile>
              <v-col>
              ...
              <v-col>
                ...
                >
                  ...
                  >
                    ...
                    <v-btn color="primary" @click="$refs.startMenu.save(signtipo.tt_end_date)">OK</v-btn>
                  </v-date-picker>
                </v-menu>
              </v-col>
            </v-card>
            ...
            <v-card class="pa-2" outlined style="border-color: lightgrey;" tile>
              ...
              <v-col class="form-group">
                ...
                <v-container>
                  <v-text-field
                    v-bind:disabled="!switches.obligado"
  ...
  methods: {
    increment() {
      this.signtipo.tt_periodicity =
        parseInt(this.signtipo.tt_periodicity, 10) + 1;
    },
    decrement() {
      this.signtipo.tt_periodicity =
        parseInt(this.signtipo.tt_periodicity, 10) - 1;
    ...
    insertar() {
      ...
      if (this.valid) {
        this.signtipo.program_id = JSON.parse(
    ...
    cambio_fijado(fijado) {
      if (fijado) {
        if (
          this.signtipo.tt_end_date == "" ||
          this.signtipo.tt_end_date == undefined
        ) {
    ...
    cambio_obligado(obligado) {
      if (obligado) {
        if (
          this.signtipo.tt_periodicity == "" ||
          this.signtipo.tt_periodicity == undefined
        )
