<template>
  <div>
    <el-row>
      <el-col :span="20">
        <div class="grid-content">
            ...
            <i class="far fa-file"></i>&nbsp;{{" Reporte de los resultados de las encuestas de satisfacción"}}
            </h1>
        </div>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :span="20" >
        <h5>
          {{"Total de encuestas respondidas: " + respondidas}}
        </h5>
        <h5>
    ...
    <v-container>
        <embed src="https://a20160298.typeform.com/report/RGn9ztac/Yx7GClikh9Oyrnqf" width="1160" height="3100"/>              
    </v-container>
