...
export default {        
    ...
    methods:{
        ...
        finalizar(){            
            var that = this
             this.$confirm(
                "¿Está seguro de finalizar esta asignación con " + this.name + "? " + "Se eliminarán todas las citas pendientes",
                "Advertencia",
                {
            ...
            .then(() => {                
                ...
                axios
                    .post("http://184.73.231.88:7002/api/tutor/finish_assignment/", this.fin)
                    .then(res => {
                    console.log(res);
                    this.$message({
                        type: "success",
