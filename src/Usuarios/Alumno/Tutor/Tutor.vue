  ...
  <el-container direction="vertical">
    ...
    <el-row :gutter="12">
        ...
        <div v-for="tutor in filterTutor" :key="tutor" class="text item" >
           <el-card class="box-card" shadow="hover"   style="border-style:dotted;  border-width: 2px;">
              ...
              <el-row :gutter="12">
                ...
                <el-col :span="7" offset="5">
                  <p></p>
                  <el-button size="mini" type="info"  icon="fas fa-search" @click="showHorario(tutor)" plain>&nbsp;Horarios</el-button>
                  <p></p>
                  <el-button size="mini" type="info"  icon="fas fa-user-plus" @click="solicitarTutor(tutor)" plain>&nbsp;Solicitar</el-button>
                </el-col>
              </el-row>
              </div>
            </el-card>
      ...
      <el-col :span="11" offset="1">
        <el-card class="box-information" style="overflow:auto" v-show="showBox">
          ...
          <h4>Acerca del tutor</h4>
            <el-form ref="formulario" :model="form" label-width="100px" label-position="left" style="margin-left:20px">
...
export default {
  ...
  methods:{
    listarTutores() {
      ...
      axios
        .get("/student/show_tutors_in_request/"+localStorage.getItem("Id_facultad"))
        .then(res => {
